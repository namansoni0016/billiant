                ...
                <form action={action} id={form.id} onSubmit={form.onSubmit} noValidate>
                    ...
                    <div className="flex flex-col gap-1 w-fit mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <Input name={fields.invoiceName.name} key={fields.invoiceName.key} defaultValue={fields.invoiceName.initialValue} placeholder="Test 123" />
                        </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <Select defaultValue="USD" name={fields.currency.name} key={fields.currency.key}>
                                <SelectTrigger>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="INR">Indian Ruppes -- INR</SelectItem>
                                </SelectContent>
                            </Select>
